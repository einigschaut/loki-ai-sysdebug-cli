...
reported via the repository's private vulnerability reporting channel
(Security tab -> "Report a vulnerability"), which reaches the maintainer
privately, or via: [INSERT CONTACT METHOD].

<!--
Maintainer note: replace "[INSERT CONTACT METHOD]" above with a concrete
contact channel (e.g. a dedicated conduct-reports mailing address) once
one exists. Until then, private vulnerability reporting is the closest
available private channel and is listed as a fallback.
-->
